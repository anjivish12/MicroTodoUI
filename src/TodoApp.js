...
const GET_TASKS_API_BASE_URL = "http://dev-get-tasks-api.dhoomdhoom.shop";
const DELETE_TASK_API_BASE_URL = "http://dev-delete-task-api.dhoomdhoom.shop";
const CREATE_TASK_API_BASE_URL = "http://dev-add-task-api.dhoomdhoom.shop";
